  ...
  return (
    <div className="relative">
      ...
      {id ? (
        ...
        <input
          className="h-12 w-full bg-transparent pl-11 pr-4 text-gray-900 outline-none"
          placeholder={
      ...
      {signer && (
        <div className="absolute inset-y-0 right-0 flex py-1.5 pr-1.5 items-center">
          ...
          {!id && !publishing && (
            <button
              onClick={shortenUrl}
              className="inline-flex items-center rounded border border-gray-400 px-1 font-sans text-xs text-gray-400 h-8"
            >
